...
public class SlimeEntityModel<T extends Entity> extends HierarchicalModel<T> {
    public static final ModelLayerLocation SLIME_LOCATION = new ModelLayerLocation(new ResourceLocation(SplendidSlimes.MODID, "textures/entity/template_slime_entity.png"), "main");
