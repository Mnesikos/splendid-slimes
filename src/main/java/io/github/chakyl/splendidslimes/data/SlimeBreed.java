...
public record SlimeBreed(String breed, MutableComponent name,
    ...
    public static final List<String> POSSIBLE_TRAITS = Arrays.asList("aquatic", "defiant", "explosive", "feral", "flaming", "floating", "foodporting", "handy", "inverse", "largoless", "moody", "nuclear", "picky", "photosynthesizing", "putrid", "spiky", "weeping");
